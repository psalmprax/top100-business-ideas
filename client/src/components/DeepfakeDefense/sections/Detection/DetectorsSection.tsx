...
import type { DeepfakeAnalysis } from "../../types";
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-tighter">
              Drag media files here or click to initiate deep-scan
            </p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-border/50 overflow-hidden bg-background/30">
          <Table>
            <TableHeader className="bg-muted/30">
              <TableRow>
                <TableHead className="text-[10px] font-black uppercase tracking-widest py-3">
                  Media
                </TableHead>
                <TableHead className="text-[10px] font-black uppercase tracking-widest py-3">
                  Type
                ...
                .map(analysis => (
                  ...
                  >
                    ...
                    <TableCell>
                      <Badge
                        variant={
                          analysis.result === "real" ? "default" : "destructive"
                        }
