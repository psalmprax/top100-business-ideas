  ...
  if (mode === "alpha") {
    ...
    return (
      ...
      >
        ...
        <h3 className="text-xl font-bold text-white mb-2 pr-10 font-display tracking-tight">
          {idea.title}
        </h3>
          ...
          <div>
            ...
            <div className="h-1 rounded-full bg-white/5">
              <div
                ...
                style={{ width: `${idea.profit_margin}%` }}
              />
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-[10px] font-mono text-white/30">
              RANK_{idea.rank.toString().padStart(3, "0")}
            </span>
          </div>
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          {idea.markets.slice(0, 2).map(m => (
            <span
              key={m}
              className="px-2 py-0.5 text-[9px] font-bold bg-[#00ff00] text-black rounded"
            >
              {m.toUpperCase()}
            </span>
          ))}
      ...
      <div className="flex items-end justify-between">
        <div className="space-y-1">
          <span className="block text-[8px] font-bold text-[#999999]">
            STRATEGIC_FIT
          </span>
