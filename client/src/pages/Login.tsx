...
const PRODUCT_MAPPING: Record<
  string,
  { label: string; icon: LucideIcon; color: string; path: string }
> = {
  "agent-ops": {
    label: "AgentOps",
    icon: Cpu,
...
export default function Login() {
  ...
  const handleOAuthLogin = async (provider: "google" | "apple") => {
    ...
    setError("");
    try {
      const result = await extendedApi.sso.connectProvider("default", provider) as Record<string, string> | null;
      if (result?.auth_url) {
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <div className="text-technical mb-2 opacity-100">
                            Identity Identifier
                          </div>
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center justify-between mb-2">
                            <div className="text-technical opacity-100">
                              Secure Passkey
                            </div>
                            <Link
                              href="/reset-password"
            ...
            <div className="mt-12 pb-12">
              <div className="relative">
                ...
                <div className="relative flex justify-center">
                  <span className="bg-[#080809] px-4 text-technical opacity-40">
                    External Auth
                  </span>
                </div>
              </div>
