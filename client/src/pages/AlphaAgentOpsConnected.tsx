...
import {
    Activity, AlertTriangle, Play, Pause, Settings,
    Plus, RefreshCw, TrendingUp, DollarSign,
    Brain, Shield, Zap, Clock, BarChart3, Users,
...
function mapAgent(apiAgent: Agent) {
    return {
        ...apiAgent,
        config: typeof apiAgent.config === 'string'
            ...
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-400">Real-time observability and governance for autonomous AI agents</p>
                    </div>
                </div>
            ...
            {activeTab === 'overview' && (
                <div className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-4 gap-4">
                        ...
                        <Card className="bg-slate-800 border-slate-700">
                            <CardHeader className="pb-2">
                                <CardTitle className="text-sm font-medium text-slate-400">Loops Prevented</CardTitle>
                            </CardHeader>
                            <CardContent>
                                {metricsLoading ? (
                                    <Skeleton className="h-8 w-24" />
                        ...
                        <CardContent>
                            {agentsLoading ? (
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <Button size="sm" className="mt-4 bg-blue-600">
                                        <Plus className="w-4 h-4 mr-2" />
                                        Create Agent
                                    </Button>
                                </div>
                                ...
                                <div className="space-y-3">
                                    {agents.map(agent => {
                                        const budgetPercent = agent.dailySpend / agent.budget * 100;
                                        return (
                                            <div
                                                key={agent.id}
                                            ...
                                            >
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-sm text-slate-400">{agent.type} • {agent.config?.model || 'N/A'}</p>
                                                    </div>
                                                </div>
                                                <div className="flex items-center gap-6">
                                                    <div className="text-right">
                                                        <p className="font-medium">${agent.dailySpend.toFixed(2)} / ${agent.budget}</p>
                                                        <Progress
                                                            value={Math.min(budgetPercent, 100)}
                                                            className="w-24 h-2 mt-1"
                                                            style={{
                                                                backgroundColor: budgetPercent > 80 ? '#ef4444' : budgetPercent > 50 ? '#eab308' : '#22c55e'
                                                            }}
                                                        />
                                                    </div>
                                                    <Button
                ...
                <Card className="bg-slate-800 border-slate-700">
                    ...
                    <CardContent>
                        <p className="text-slate-400 text-center py-8">
                            Real-time audit logs will appear here when agents are running.
                        </p>
                    </CardContent>
                </Card>
            )}
