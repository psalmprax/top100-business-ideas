...
| Field             | Description                              |
| ----------------- | ---------------------------------------- |
| Problem           | The user pain point                      |
| Category          | productivity / finance / automation etc  |
| Platform          | Where discussion occurred                |
| Community         | Subreddit/forum                          |
| Thread Title      | Discussion topic                         |
| Approx. Date      | Timestamp                                |
| Comments          | Engagement metric                        |
| Signal Type       | complaint / request / willingness to pay |
| Opportunity Score | low / medium / high                      |

---

## Example Format (Demonstration Only)

These entries demonstrate the **template structure** - not validated startup ideas. Replace with your own collected data.

### Example 1: Automation Failure Monitoring

| Field        | Data                               |
| ------------ | ---------------------------------- |
| Problem      | Automation workflows fail silently |
| Category     | Automation                         |
| Platform     | Reddit                             |
| Community    | r/nocode                           |
...
### Example 2: Recurring Payment Tracking
...
### Example 6: Bookmark Organization

| Field        | Data              |
| ------------ | ----------------- |
| Problem      | Bookmark overload |
| Category     | Productivity      |
| Platform     | [Platform]        |
| Community    | [Community]       |
| Thread Topic | [Thread title]    |
...
### Example 8: Cloud File Organization
