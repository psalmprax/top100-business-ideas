...
**Scenario**: A user wearing an Apple Vision Pro or Meta Quest needs to authorize a $1M transaction. The device's "Optic ID" or face-scan must be verified as a live person, not a high-res video being played _inside_ the headset.
