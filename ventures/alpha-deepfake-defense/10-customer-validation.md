...
1. **Zero Trust is the only way**: Treasurers do not want "AI Detection". Detection is an arms race the defenders will lose. They want a **Cryptographic Hardware Signature**. The fact that our software uses iOS FaceID Secure Enclaves _bypasses_ the deepfake problem entirely.
