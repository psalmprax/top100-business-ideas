...
*Inspecting 1M tokens through the Rust proxy costs us approximately £0.05 in compute.*
*Offering a 1M token free tier costs us penties per user.*
...
*Marketing message*: "You pay OpenAI £5.00 for 1M GPT-4 Output tokens. You pay us £1.20 to ensure those 1M tokens weren't wasted on a hallucination loop. Sentinel pays for itself if it catches a single 25% failure rate."
