...
| ----- | ------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Focus | Pure SaaS Invoicing | B2B FinTech | Standard SaaS invoicing is a commodity (Xero/QBO do it). True value in construction is providing the _liquidity_ to pay invoices instantly (Factoring). |
