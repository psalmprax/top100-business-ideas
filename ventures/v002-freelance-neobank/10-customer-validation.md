...
|------|---------|----------|--------|
| Accounting | Build our own | Partner/Integrate | Initially planned to build accounting software. Pivoted to simply categorized transactions and pushing them cleanly to Xero/Quickbooks. We are the *data source*, not the *end ledger*. |
