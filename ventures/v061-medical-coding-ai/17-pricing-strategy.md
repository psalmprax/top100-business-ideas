...
_Note: Pricing scales drastically based on the complexity of the medical specialty. A simple X-Ray is cheap to code; a 40-day ICU stay is incredibly expensive to code._
...
| **Legacy Rules Engines (3M)**               | Massive multi-million flat fees | Requires human data entry _before_ the engine works.                | We read the raw, messy unstructured text directly. |
